...
## Video 8.4
- [MicroProfile 1.2 Samples for Metrics](microprofile1.2-samples) ‒ A subset of [MicroProfile 1.2 Samples](https://github.com/javaee-samples/microprofile1.2-samples) adjusted for integration with Prometheus or Grafana and other demos in Section 8.
